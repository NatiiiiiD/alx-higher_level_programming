#!/usr/bin/python3
"""Square module.
IN this module it contains a class that defines a square and its size and its
...
class Square():
    ...
    def __init__(self, size=0, position=(0, 0)):
        """Sets all the necessary attributes for the Square object.
        Args:
            size (int): indicate the size of one edge of the square.
    ...
    def my_print(self):
        """Prints all the square with the # character on stdout."""
        if self.__size > 0:
